import{r as p,b as l,c as y,d as g,L as P}from"./utils-CGGOHlq-.js";import{P as $}from"./ProductData-BzbZu8QD.js";function i(t,e){var r,s;return((r=t.Images)==null?void 0:r[e])||t.Image||((s=t.Images)==null?void 0:s.PrimaryMedium)||""}function S(t){return[[i(t,"PrimarySmall"),"80w"],[i(t,"PrimaryMedium"),"160w"],[i(t,"PrimaryLarge"),"320w"]].filter(([r])=>r).map(([r,s])=>`${l(r)} ${s}`).join(", ")}function L(t,e){const r=i(t,"PrimaryMedium"),s=S(t),a=t.Category||e||"",f=a?`&category=${a}`:"";return`<li class="product-card">
